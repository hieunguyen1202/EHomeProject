...
<html>
    ...
    <body>
        <c:set  value="${facility}" var="c"></c:set>
        ...
        <div class="container">
            <h2 class="text-center mt-3">Update Facility</h2>
            <form action="updatefacility" method="POST">
                <input type="hidden" name="facilityId" value="${c.facilityId}">
                <div class="row">
                    ...
                    <div class="col-lg-6"  style="background-color: #F6F4EB;border-radius: 10px;padding: 20px">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control"  name="icon" value='${c.icon}'>
                        </div> 
                        <div class="form-group">
